...
import com.cheng.game2358.ui.view.GameLayout;
...
public class GameFragment extends BaseFragment {
    ...
    protected void initView(View rootView) {
        ...
        scoreText.setTextColor(getResources().getColor(R.color.yin));
        bestText   = (TextView)    rootView.findViewById(R.id.text_best);
        bestText.setTextColor(getResources().getColor(R.color.huang));
        backBtn    = (ImageButton) rootView.findViewById(R.id.btn_back);
        backBtn.setColorFilter(getResources().getColor(R.color.shui));
        refreshBtn = (ImageButton) rootView.findViewById(R.id.btn_refresh);
        refreshBtn.setColorFilter(getResources().getColor(R.color.shua));
        movesText  = (TextView)    rootView.findViewById(R.id.text_moves);
        movesText.setTextColor(getResources().getColor(R.color.lanlan));
        timeText   = (TextView)    rootView.findViewById(R.id.text_time);
       timeText.setTextColor(getResources().getColor(R.color.lv));
